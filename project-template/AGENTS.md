...
Per ticket, per run: a claim, a question if you genuinely need one, and a
hand-off. That is the cap. A run that wants a fourth comment is a run that is
narrating instead of working. Say the thing once.
